...
const submit_grn = () => {
  ...
  axios.post("/downstream/scRNA/grn", formData, {
    headers: {
  ...
  <div v-show="store.displayOther">
    ...
    <div class="parameters">
      ...
      <div class="EnterID">
          ...
          <p>Enter data index in "for downstream analysis" to do gene regulative network ananlysis:
            <input type="text" v-model="data_index">
          </p>
          <p>
            number of threads to use: <input type="text" v-model="threads">
          </p>
          <p>
            <input type="button" value="submit" @click="submit_grn()">
          </p>
          <br>
      </div>
