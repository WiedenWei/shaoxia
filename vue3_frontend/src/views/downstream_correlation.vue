...
const submit_correlation = () => {
  ...
  axios.post("/downstream/scRNA/correlation", formData, {
    headers: {
...
<template>
  ...
  <div v-show="store.displayOther">
    ...
    <div class="header">
      <h1>Downstream</h1>
      <h2>scRNA-seq data | cell cluster correlation</h2>
    </div>
    ...
    <div class="parameters">
      ...
      <div class="EnterID">
          ...
          <p>Enter data index in "for downstream analysis" to do correlation analysis:
            <input type="text" v-model="data_index">
          </p>
          <p>
            <input type="button" value="submit" @click="submit_correlation()">
          </p>
          <br>
      </div>
