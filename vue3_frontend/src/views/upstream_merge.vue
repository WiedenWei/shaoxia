...
const scRNAmerge = () => {
  ...
  axios.post("/upstream/scRNA/merge", formData, {
    headers: {
...
<template>
  ...
  <div v-show="store.displayOther">
    ...
    <div class="header">
      <h1>Upstream</h1>
      <h2>scRNA-seq data | merge multi-sample data</h2>
    </div>

    <div class="parameters">
        <h3>Enter Data ID to merge</h3>
        <h4>NOTE: click "query data for analysis -- for merge/integrate" to get data id for merge</h4>
        ...
        <br>
        <p> <input type="button" value="submit" @click="scRNAmerge()"> </p>
