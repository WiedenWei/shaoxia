...
const submit_cellcycle = () => {
  ...
  axios.post("/downstream/scRNA/cellCycle", formData, {
    headers: {
...
<template>
  ...
  <div v-show="store.displayOther">
    ...
    <div class="header">
      <h1>Downstream</h1>
      <h2>scRNA-seq data | cell cycle scoring</h2>
    </div>
    ...
    <div class="parameters">
      ...
      <div class="EnterID">
          ...
          <p>Enter data index in "for downstream analysis" to do cell cycle scoring:
            <input type="text" v-model="data_index">
          </p>
          <p>
            <input type="button" value="submit" @click="submit_cellcycle()">
          </p>
          <br>
      </div>
