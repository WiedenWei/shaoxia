...
const upload_data = function(){
  ...
  formData.append('data_type', "matrix")
...
<div v-show="store.displayOther">
  ...
  <div v-show="store.displayOther">
    ...
    <div class="header">
      <h1>Upload</h1>
      <h2>scRNA-seq data | cell-gene count matrix file</h2>
    </div>
    ...
    <div class="files">
        <br>
        <p>NOTE: select a cell-gene count matrix file to upload.</p>
