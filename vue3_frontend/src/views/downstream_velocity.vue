...
const submit_velocity = () => {
  ...
  axios.post("/downstream/scRNA/velocity", formData, {
    headers: {
...
<template>
  ...
  <div v-show="store.displayOther">
    ...
    <div class="header">
      <h1>Downstream</h1>
      <h2>scRNA-seq data | RNA velocity</h2>
    </div>
    ...
    <div class="parameters">
      ...
      <div class="EnterID">
          ...
          <p>
            NOTE: RNA velocity can only apply for generate loom file data.
          </p>
          <p>
            <input type="button" value="submit" @click="submit_velocity()">
          </p>
          <br>
      </div>
