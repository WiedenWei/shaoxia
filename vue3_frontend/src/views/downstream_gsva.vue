...
const submit_gsva = () => {
  ...
  axios.post("/downstream/scRNA/gsva", formData, {
    headers: {
  ...
  <div v-show="store.displayOther">
    ...
    <div class="parameters">
      ...
      <div class="EnterID">
        ...
        <p>Enter data index in "for downstream analysis" to do GSVA analysis:
        ...
        <p>
          <input type="button" value="submit" @click="submit_gsva()">
        </p>
          <br>
      </div>
